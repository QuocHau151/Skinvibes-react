...
export declare function Rating({ onClick, ratingValue, iconsCount, size, readonly, fillColor, fillColorArray, emptyColor, fullIcon, emptyIcon, customIcons, rtl, allowHalfIcon, allowHover, transition, className, style, fullClassName, emptyClassName, fullStyle, emptyStyle, showTooltip, tooltipDefaultText, tooltipArray, tooltipClassName, tooltipStyle }: Props): JSX.Element;
export {};
